...
{
    /// <inheritdoc />
    public partial class hhytr : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duration = table.Column<int>(type: "int", nullable: true),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FirstLocation = table.Column<int>(type: "int", nullable: true),
                    SecondLocation = table.Column<int>(type: "int", nullable: true),
                    FirstLocationDuration = table.Column<int>(type: "int", nullable: true),
                    SecondLocationDuration = table.Column<int>(type: "int", nullable: true),
                    BookingTimeAllowed = table.Column<int>(type: "int", nullable: true),
